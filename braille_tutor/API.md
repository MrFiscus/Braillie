...
```json
{
  ...
  "camera":  {"ok": true, "frames": 812, "dropped": 0},
  ...
  "finger":  {"page_mm": [62.5, 51.0], "source": "camera", "cell": {"letter": "h", "label": "H", "name": "the letter H", "dots": [1, 2, 5], "row": 0, "col": 7}},
